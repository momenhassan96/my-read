            ...
            {props.bookData &&
                <div className="book">
                    <div className="book-top">
                        <div className="book-cover" style={{ width: 128, height: 193, backgroundImage: `url(${props.bookData.imageLinks.thumbnail ? props.bookData.imageLinks.thumbnail : props.bookData.imageLinks.smallThumbnail})` }}></div>
